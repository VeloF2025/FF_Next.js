...
import approveHandler from '@/pages/api/works-qa/photo-approve';
import snagHandler from '@/pages/api/works-qa/photo-snag';
import resolveHandler from '@/pages/api/works-qa/photo-snag-resolve';
import listHandler from '@/pages/api/works-qa/photo-snags';
import reportHandler from '@/pages/api/works-qa/pole-snag-report';
import assignablesHandler from '@/pages/api/works-qa/assignable-users';
