---
name: navigation
description: Navigation migration skill. Convert FibreFlow modules from sidebar sub-items to horizontal tab-based navigation. USE WHEN user says 'migrate module to tabs', 'add tab navigation', 'convert sidebar to tabs', '/navigation'.
