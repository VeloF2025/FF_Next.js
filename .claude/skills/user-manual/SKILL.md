---
name: user-manual
description: Update the complete FibreFlow user manual with recent feature changes and regenerate help center content. USE WHEN user says '/user-manual', 'update user manual', 'update manual', 'update help center'.
