---
name: openclaw
description: OpenClaw Agent Fleet and Mission Control. Diagnostics, cron management, MC messaging, proactive monitoring, fleet maintenance. USE WHEN user says '/openclaw', '/mc', 'mission control', 'agent fleet', 'cron jobs', 'fleet status', 'agent status'.
---
