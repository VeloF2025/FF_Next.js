---
name: dr
description: Daily Report (DR) management for FibreFlow. Check status, find missing DRs, trigger reprocessing, manage VLM categorization. USE WHEN user says '/dr', 'daily report', 'DR status', 'missing DR', 'DR not submitted', 'acknowledge DR', 'retry DR', 'VLM categorization', 'foto_ai_reviews'.
---
