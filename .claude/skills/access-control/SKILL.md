---
name: access-control
description: Audit and update RBAC permission definitions when features change. Scan API routes for auth middleware, check permission database entries, seed missing permissions. USE WHEN user says '/access-control', 'audit access control', 'update permissions', 'rbac audit'.
---
