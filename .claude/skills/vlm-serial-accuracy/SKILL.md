---
name: vlm-serial-accuracy
description: VLM extraction accuracy improvement. Autoresearch loop for all VLM-extracted data including serials, power meter, plates, odometer, fuel, categorization, QA. USE WHEN user says '/vlm-accuracy', 'improve VLM', 'serial accuracy', 'ONT serial accuracy', 'power meter accuracy', 'odometer accuracy', 'plate reading accuracy', 'VLM errors', 'VLM corrections', 'fix extraction', 'retest VLM'.
---
