---
name: fibre
description: Fibre network GIS management. Poles, fibre cables, splices, drops, routing, QField sync, 1Map integration. USE WHEN user says '/fibre', 'fibre network', 'pole status', 'splice closure', 'fibre routing', 'cable route', 'fibre cable', 'fibre coverage', 'network topology', 'ONT serial', 'fibre map'.
---
