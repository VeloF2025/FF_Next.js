---
name: odoo
description: Odoo data sync and reconciliation for FibreFlow. Diagnose gaps, trigger re-syncs, reconcile stock/GRN/PO data. USE WHEN user says '/odoo', 'odoo sync', 'odoo broken', 'GRN not matched', 'serial mismatch', 'vendor bill missing', 'stock quantity wrong', 'sync odoo'.
---
