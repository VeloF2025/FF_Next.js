---
name: db
description: Database schema management for FibreFlow Neon PostgreSQL. Schema diff, migrations, branch comparison, safe query execution. USE WHEN user says '/db', 'database schema', 'schema diff', 'schema migration', 'migration script', 'neon branch', 'schema drift', 'run migration', 'create table', 'alter table'.
---
