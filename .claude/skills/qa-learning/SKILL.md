---
name: qa-learning
description: QA Learning module reference. HITL few-shot learning system for VLM photo categorization improvement using human corrections as training examples. USE WHEN working on QA correction examples, few-shot prompts, or VLM accuracy improvement.
