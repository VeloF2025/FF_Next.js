---
name: go-bridge
description: Go WhatsApp bridge reference. DR validation, acknowledgment sending with threaded replies, LID format handling, service management, log analysis. USE WHEN troubleshooting Go bridge, DR processing, or WA acknowledgments.
---
