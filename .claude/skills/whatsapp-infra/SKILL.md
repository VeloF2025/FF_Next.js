---
name: whatsapp-infra
description: WhatsApp infrastructure reference. Go bridge, VPS services, DR photo processing pipeline, and pole installation ACK architecture. USE WHEN troubleshooting WhatsApp services, bridge issues, or WA infrastructure.
---
