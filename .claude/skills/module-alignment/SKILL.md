...
description: Align RBAC permissions, Help Center docs, and Chatbot with new modules. USE WHEN user says '/align', '/module-alignment', 'align module', 'align rbac help chatbot'.
