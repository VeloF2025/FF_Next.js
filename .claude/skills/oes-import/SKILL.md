---
name: oes-import
description: OES import skill. Import and manage Nokia OES activation reports for FibreFlow. Daily Excel report imports with upsert behavior and drops reconciliation. USE WHEN user says 'OES import', 'OES report', 'activation report', 'Nokia OES'.
---
