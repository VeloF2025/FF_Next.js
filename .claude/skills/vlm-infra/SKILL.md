---
name: vlm-infra
description: VLM infrastructure reference. Qwen3-VL-8B-Instruct on Velocity Server configuration, GPU management, service management, and troubleshooting. USE WHEN diagnosing VLM infrastructure issues, GPU problems, or service configuration.
---
