---
name: sage-api
description: Sage Business Cloud Accounting South Africa integration reference. SA-specific Basic Auth API, not global OAuth. USE WHEN working on Sage API integration, accounting sync, or SA Sage configuration.
