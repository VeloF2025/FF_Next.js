---
name: ai-qa-validation
description: AI QA Validation reference. VLM-powered photo quality validation using Qwen3 against FiberTime Installation Standards. USE WHEN working on VLM validation criteria, AI QA assessment, or photo quality checks.
---
