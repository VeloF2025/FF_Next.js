---
name: access
description: User permission management for FibreFlow RBAC. Check user permissions, grant/deny overrides, debug permission issues. USE WHEN user says '/access', 'check permissions', 'grant permission', 'deny permission', 'debug permission', 'user access'.
---
