---
name: wa-monitor
description: WA Monitor auto-responder skill. Detect WhatsApp Monitor issues and proactively invoke diagnostics. USE WHEN drop numbers mentioned (DR pattern), WA service issues, or validation problems detected.
---
