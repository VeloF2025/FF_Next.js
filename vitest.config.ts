...
export default defineConfig({
  test: {
    ...
    exclude: [
      ...
      'tests/migrations/531_velocity_site_aois.test.ts',
      'tests/migrations/531_velocity_site_aois_cron_wiring.test.ts',
      ...
      'tests/migrations/510_fleet_incident_source_event_producer.test.ts',
      ...
      'tests/migrations/524_oes_pp_exit_reason.test.ts',
