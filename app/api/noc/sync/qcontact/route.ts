 ...
 *
 * POST /api/noc/sync/qcontact - Trigger full bidirectional sync
 *
 * Features:
...
import {
  ...
  runInboundOnlySync,
  runOutboundOnlySync,
} from '@/modules/noc/services/qcontactSyncOrchestrator';
import { SyncDirection } from '@/modules/noc/types/qcontact';
import type { FullSyncRequest } from '@/modules/noc/types/qcontact';
