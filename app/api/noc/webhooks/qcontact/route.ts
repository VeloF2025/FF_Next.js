 ...
 *
 * POST /api/noc/webhooks/qcontact - Receive QContact webhook events
 *
 * Features:
...
import { syncSingleInboundTicket } from '@/modules/noc/services/qcontactSyncInbound';
import { queryOne } from '@/modules/noc/utils/db';
import type { QContactWebhookPayload, QContactTicket } from '@/modules/noc/types/qcontact';
import { SyncDirection, SyncType, SyncStatus } from '@/modules/noc/types/qcontact';
...
// ============================================================================
// POST /api/noc/webhooks/qcontact
// ============================================================================
