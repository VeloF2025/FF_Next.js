 ...
 *
 * GET /api/noc/notifications/status - Get notification delivery status
 *
 * Query parameters:
 ...
 *
 * @module api/noc/notifications/status
 */

import { NextRequest, NextResponse } from 'next/server';
import { createLogger } from '@/lib/logger';
import { getDefaultWhatsAppService } from '@/modules/noc/services/whatsappService';
import type { NotificationFilters } from '@/modules/noc/types/whatsapp';
import { NotificationStatus, RecipientType } from '@/modules/noc/types/whatsapp';
...
// ==================== GET /api/noc/notifications/status ====================

/**
 * 🟢 WORKING: Get notification delivery status
 *
 * @example Get single notification status:
 * GET /api/noc/notifications/status?notification_id=notif-uuid
 *
 * Response (200):
 * {
 *   "success": true,
 ...
 * GET /api/noc/notifications/status?ticket_id=ticket-uuid
 *
 * Response (200):
 * {
 *   "success": true,
