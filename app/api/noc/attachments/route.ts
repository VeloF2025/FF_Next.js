 ...
 *
 * POST /api/noc/attachments - Upload file to Firebase Storage
 *
 * Features:
...
import { uploadAttachment } from '@/modules/noc/services/attachmentService';
import type { FileUploadRequest } from '@/modules/noc/types/attachment';

const logger = createLogger('maintenance:api:attachments');

// ==================== POST /api/noc/attachments ====================
