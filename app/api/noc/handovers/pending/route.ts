 ...
 *
 * GET /api/noc/handovers/pending - List tickets pending handover
 *
 * Query Parameters:
...
import { getPendingHandovers } from '@/modules/noc/services/handoverService';
import { HandoverType } from '@/modules/noc/types/handover';
