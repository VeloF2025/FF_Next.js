 ...
 *
 * GET /api/noc/escalations - List all escalations with optional filters
 *
 * Features:
...
import { listEscalations } from '@/modules/noc/services/escalationService';
import {
  EscalationScopeType,
  EscalationStatus,
  EscalationType,
} from '@/modules/noc/types/escalation';
import type { EscalationFilters } from '@/modules/noc/types/escalation';
