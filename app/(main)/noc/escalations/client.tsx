...
import { EscalationList } from '@/modules/noc/components/Escalation/EscalationList';
import { EscalationAlert } from '@/modules/noc/components/Escalation/EscalationAlert';
import { RepeatFaultMap } from '@/modules/noc/components/Escalation/RepeatFaultMap';
import type { RepeatFaultEscalation, RepeatFaultAlert } from '@/modules/noc/types/escalation';
...
export default function EscalationsPageClient() {
  ...
  useEffect(() => {
    async function fetchEscalations() {
      try {
        setIsLoading(true);
        const response = await fetch('/api/noc/escalations');
        if (!response.ok) {
