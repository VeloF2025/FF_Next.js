...
import { HandoverWizard } from '@/modules/noc/components/Handover/HandoverWizard';
import { HandoverHistory } from '@/modules/noc/components/Handover/HandoverHistory';
...
import { HandoverType, OwnerType } from '@/modules/noc/types/handover';
...
export default function HandoverCenterPageClient() {
  ...
  const fetchPendingHandovers = useCallback(async () => {
    ...
    try {
      let url = '/api/noc/handovers/pending?';
