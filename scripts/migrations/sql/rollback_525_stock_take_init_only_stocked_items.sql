-- rollback_525_stock_take_init_only_stocked_items.sql
-- Restores the 493 version of initialize_stock_take_lines (one line per ALL
-- active items, zero-stock lines included).
