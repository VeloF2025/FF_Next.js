...
INSERT INTO stock_serial_status_transitions (from_state, to_state, event_type, description) VALUES
  ...
  ('in_stock',            'installed',            'installed_at_drop',     'OES cascade — direct install (picking event missed)'),
  ('available',           'installed',            'installed_at_drop',     'OES cascade — legacy pre-backfill direct install'),
  ('allocated_to_project','installed',            'installed_at_drop',     'OES cascade — direct install from project allocation'),
