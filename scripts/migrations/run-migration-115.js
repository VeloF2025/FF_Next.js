/**
 * Migration Runner: 115 Odoo Attachments
 *
 * Run with:
 *   DATABASE_URL='...' node scripts/migrations/run-migration-115.js
 */
...
async function runMigration() {
  ...
  console.log('Migration 115: Odoo Document/Attachment Sync');
  console.log('='.repeat(60));
  console.log('');

  try {
    // Read the SQL file
    const sqlPath = path.join(__dirname, '115_odoo_attachments.sql');
