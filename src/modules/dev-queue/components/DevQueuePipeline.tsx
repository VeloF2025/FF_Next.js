...
export function DevQueuePipeline({ items, onRefresh }: DevQueuePipelineProps) {
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-[var(--ff-text-secondary)]">
            Approved devQueue items being built by Claude Code
          </p>
        </div>
        <button
      ...
      {pipelineItems.length === 0 ? (
        <div className="text-center py-12 bg-[var(--ff-bg-secondary)] rounded-lg">
          ...
          <p className="text-sm text-[var(--ff-text-secondary)] max-w-md mx-auto">
            When you approve a devQueue item with effort XS, S, or M, it will automatically
...
export default DevQueuePipeline;
