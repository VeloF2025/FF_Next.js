...
import type { WishlistColumn } from '../types/wishlist';
...
export function WishlistSettings({ columns, onColumnsUpdated }: WishlistSettingsProps) {
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      await wishlistService.updateColumns(columnSettings);
