 ...
 * Last updated: 2026-02-10T08:47:34.838Z
 * 
...
<img src="/help-assets/velocity-logo.jpg" alt="Velocity Fibre Logo" />
...
![Maintenance Dashboard](/help-screenshots/complete/16-maintenance-dashboard.png)
...
![Kanban Board](/help-screenshots/complete/17-maintenance-kanban.png)
...
![Procurement Dashboard](/help-screenshots/complete/18-procurement-dashboard.png)
...
![BOQ List](/help-screenshots/complete/19-procurement-boq.png)
...
![RFQ Detail](/help-screenshots/complete/20-procurement-rfq.png)
...
![Purchase Order](/help-screenshots/complete/21-procurement-po.png)
...
![Stock Management](/help-screenshots/complete/22-procurement-stock.png)
...
![Assets Dashboard](/help-screenshots/complete/23-assets-dashboard.png)
...
![Assets List](/help-screenshots/complete/24-assets-list.png)
...
![Fleet Dashboard](/help-screenshots/complete/25-fleet-dashboard.png)
...
![Vehicles List](/help-screenshots/complete/26-fleet-vehicles.png)
...
![Staff Directory](/help-screenshots/complete/27-staff-directory.png)
...
![Staff Detail](/help-screenshots/complete/28-staff-detail.png)
...
![Departments](/help-screenshots/complete/29-departments.png)
...
![Analytics Dashboard](/help-screenshots/complete/30-analytics-dashboard.png)
...
![Communications](/help-screenshots/complete/31-communications.png)
...
![WhatsApp Admin](/help-screenshots/complete/32-whatsapp-admin.png)
...
![System Health](/help-screenshots/complete/33-system-health.png)
...
![Data Sync](/help-screenshots/complete/34-data-sync.png)
...
![Settings](/help-screenshots/complete/35-settings.png)
...
export function parseManualSections(): ManualSection[] {
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    if (line.match(/^## \d+\./)) {
      ...
      // Start new section
      const title = line.replace(/^## \d+\.\s*/, '').replace(/\*\*\(([^)]+)\)\*\*/g, '($1)').replace(/\*\*/g, '');
      currentSection = {
        id: slugify(title),
        title,
        content: '',
    ...
    // Subsection (### Title)
      ...
      const title = line.replace(/^###\s*/, '').replace(/\*\*\(([^)]+)\)\*\*/g, '($1)').replace(/\*\*/g, '');
      currentSubsection = {
        id: slugify(title),
        title,
        content: ''
