...
- `contractor_stock_accountability` — blocking status per technician
...
| Technician shows as blocked | Query `contractor_stock_accountability` — may need manual unblock |
