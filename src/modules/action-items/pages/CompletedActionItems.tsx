    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-[var(--ff-text-primary)]">Completed Action Items</h1>
            <p className="text-[var(--ff-text-secondary)] mt-1">Successfully completed items</p>
          </div>
        </div>
      </div>
