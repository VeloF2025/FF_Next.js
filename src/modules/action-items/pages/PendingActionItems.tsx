    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-[var(--ff-text-primary)]">Pending Action Items</h1>
            <p className="text-[var(--ff-text-secondary)] mt-1">Items awaiting completion</p>
          </div>
        </div>
      </div>
