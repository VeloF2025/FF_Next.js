    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">Track all poles, drops, and fiber sections in one place</p>
        </div>
        <div className="flex gap-2">
          <button
            onClick={() => refetch()}
            className="px-4 py-2 border rounded-lg hover:bg-gray-50 dark:bg-gray-900 flex items-center gap-2"
          >
