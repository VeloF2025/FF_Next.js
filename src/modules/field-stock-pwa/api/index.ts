...
export { validateSerial, validateSerialBatch, extractSerialFromPhoto } from './serials';
export type { SerialExtractResult, BatchSerialResult, BatchSerialResponse } from './serials';
