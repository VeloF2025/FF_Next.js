    ...
    <div className={cn("p-6 rounded-lg border", statusStyle.color)}>
      ...
      <div className="flex items-end justify-between">
        ...
        <div className="text-right">
          <div className="w-16 h-16 bg-card bg-opacity-50 rounded-lg flex items-center justify-center">
  ...
  return (
    <div className="bg-card p-6 rounded-lg border border-border">
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="text-3xl font-bold text-foreground">{overallScore.toFixed(1)}/4.0</div>
...
function BenchmarkingSection({ }: { metrics: PerformanceMetric[] }) {
  ...
  return (
    <div className="bg-card p-6 rounded-lg border border-border">
      <h3 className="text-lg font-semibold text-foreground mb-4">Industry Benchmarking</h3>
      
      <div className="space-y-4">
        {benchmarkData.map((benchmark, index) => (
          <div key={index} className="flex items-center justify-between py-3 border-b border-gray-100 last:border-0">
            <div>
              <p className="font-medium text-foreground">{benchmark.category}</p>
