      ...
      <div className="bg-card rounded-lg shadow p-6">
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Compare and sync fiber cable data between systems</p>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-4 py-2 bg-card border border-border rounded-md text-muted-foreground hover:bg-background disabled:bg-secondary disabled:cursor-not-allowed flex items-center gap-2"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-card rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-muted-foreground">QFieldCloud Cables</p>
                  <p className="text-2xl font-semibold text-foreground mt-1">{stats.qfieldcloud_total}</p>
                </div>
            ...
            <div className="bg-card rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-muted-foreground">FibreFlow Cables</p>
                  <p className="text-2xl font-semibold text-foreground mt-1">{stats.fibreflow_total}</p>
                </div>
            ...
            <div className="bg-card rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-semibold text-foreground mt-1">{stats.synchronized}</p>
                </div>
                <div className="bg-green-100 p-3 rounded-full">
            ...
            <div className="bg-card rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-semibold text-foreground mt-1">{stats.needs_sync}</p>
                </div>
                ...
                {qfieldCables.length > 0 ? (
                  <div className="space-y-3 max-h-96 overflow-y-auto">
                    {qfieldCables.slice(0, 10).map((cable) => (
                      <div key={cable.cable_id} className="border border-border rounded-lg p-3">
                        <div className="flex justify-between items-start">
                          <div>
                            <p className="font-medium text-foreground">{cable.cable_id}</p>
                  ...
                  <p className="text-muted-foreground text-center py-8">No fiber cable data available</p>
                )}
              </div>
            </div>
      ...
      {view === 'details' && (
        <div className="bg-card rounded-lg shadow">
          <div className="px-6 py-4 border-b border-border">
            <h3 className="text-lg font-semibold text-foreground">All Cables ({cables.length})</h3>
          </div>
