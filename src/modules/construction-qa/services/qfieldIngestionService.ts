 ...
 * be registered for extraction and silently absent here — which is how seven entries
 * went missing. `test_qfield_map_matches_db` now fails when they diverge.
 *
...
const QFIELD_TO_FIBREFLOW: Record<string, string> = {
  ...
  // qfield_photo_validations and stopped: 6,364 rows eligible under this service's own
  ...
  '0fc570b5-99e6-4d8a-b906-10c6257d6a9d': '574a7856-3582-46aa-9094-1c434855d176', // Grabouw Drill Survey → Grabouw
};
