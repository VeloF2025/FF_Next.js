          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-foreground">{data.totalSuppliers}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">4.5+ Rating</p>
              </div>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-card divide-y divide-gray-200">
                {data.topPerformers.slice(0, 10).map((supplier) => (
                  <tr key={supplier.supplierId} className="hover:bg-background">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <span className="text-sm text-foreground">{supplier.rating.toFixed(1)}</span>
                      </div>
                    </td>
