            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-card rounded-lg border border-border">
                <div className="p-6 border-b border-border">
                  <h3 className="text-lg font-semibold text-foreground mb-2">Create Purchase Order</h3>
                ...
                <div className="p-6">
                  <div className="text-center py-12">
                    ...
                    <h4 className="text-lg font-medium text-foreground mb-2">Purchase Order Creation Form</h4>
      ...
      <div className="flex items-center justify-between">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-2">
            <h4 className="text-lg font-medium text-foreground">{poNumber}</h4>
