    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute top-full left-0 right-0 mt-1 bg-card border border-border rounded-lg shadow-lg z-50">
              ...
              <div className="py-1 border-b border-gray-100">
                <button
                  ...
                  className={`w-full px-4 py-3 text-left hover:bg-blue-50 transition-colors ${
                    viewMode === 'all' ? 'bg-blue-50 text-blue-700' : 'text-foreground'
                  }`}
                >
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">Aggregate view across all projects</div>
                    </div>
                  </div>
                </button>
              </div>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">{project.code || 'No code'}</div>
                      </div>
                    </div>
                  </button>
                ))}
          ...
          {/* Actions */}
          <div className="p-3 border-t border-gray-100 bg-background">
