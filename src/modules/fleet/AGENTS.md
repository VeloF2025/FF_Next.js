...
- A TOTAL_ONLY aggregate publishes a component's root total with a NULL denominator and none of its members — omit the missing keys and notice them; never render them as 0. A purged month has no histogram at all (no bucket columns in the view)
