...
export const prepareAssignmentReplacement = (tx: Db, id: string): Promise<unknown[]> => tx.query(`UPDATE fleet_operational_assignments SET status='superseded',superseded_by=NULL,updated_at=NOW() WHERE id=$1`, [id]);
