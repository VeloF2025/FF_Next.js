...
describe('getIncidentActions and getIncidentEvidence', () => {
  ...
  it('selects visibility so a manager can distinguish internal notes from driver-shared/driver-submitted ones (migration 507)', async () => {
 ...
 * at all. Column names asserted here are verified against migration 507
 ...
 * `fleet_incident_driver_submissions` columns (migration 507) — not a re-derived heuristic.
 */
describe('getIncidentDriverInputSummary', () => {
  ...
  it('reads the current non-superseded request and surfaces respondBy, verified against migration 507 columns', async () => {
