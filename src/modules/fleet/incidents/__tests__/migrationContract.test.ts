...
const migrationPath = resolve(process.cwd(), 'scripts/migrations/sql/499_fleet_operational_incidents.sql');
const rollbackPath = resolve(process.cwd(), 'scripts/migrations/sql/rollback_499_fleet_operational_incidents.sql');
...
describe('fleet operational incidents migration contract', () => {
  ...
  it('rolls back only PR6 objects in dependency-safe reverse order', () => {
    ...
    expect(sql).toContain("filename = '499_fleet_operational_incidents.sql'");
