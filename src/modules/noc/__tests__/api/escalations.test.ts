 ...
 *
 * Tests for:
 * - GET /api/noc/escalations - List escalations with filters
 * - GET /api/noc/escalations/{id} - Get escalation detail
 * - POST /api/noc/escalations/{id}/resolve - Resolve escalation
 * - GET /api/noc/repeat-faults/check - Check for repeat fault patterns
 *
...
describe('Escalation API Endpoints', () => {
  ...
  describe('GET /api/noc/escalations', () => {
  ...
  describe('GET /api/noc/escalations/{id}', () => {
  ...
  describe('POST /api/noc/escalations/{id}/resolve', () => {
  ...
  describe('GET /api/noc/repeat-faults/check', () => {
