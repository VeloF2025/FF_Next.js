 ...
 * - POST /api/noc/tickets/[id]/qa-readiness-check
 * - GET /api/noc/tickets/[id]/qa-readiness
 *
...
describe('POST /api/noc/tickets/[id]/qa-readiness-check', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('should run readiness check when check passes', async () => {
    ...
    const request = new NextRequest(
      `http://localhost:3000/api/noc/tickets/${mockTicketId}/qa-readiness-check`,
      {
        method: 'POST',
  ...
  it('should return 422 for invalid ticket ID format', async () => {
    ...
    const request = new NextRequest(
      `http://localhost:3000/api/noc/tickets/${invalidId}/qa-readiness-check`,
      {
        method: 'POST',
        body: JSON.stringify({}),
      }
...
describe('GET /api/noc/tickets/[id]/qa-readiness', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('should return readiness status when ticket is ready', async () => {
    ...
    const request = new NextRequest(
      `http://localhost:3000/api/noc/tickets/${mockTicketId}/qa-readiness`,
      { method: 'GET' }
    );
  ...
  it('should return 422 for invalid ticket ID format', async () => {
    ...
    const request = new NextRequest(
      `http://localhost:3000/api/noc/tickets/${invalidId}/qa-readiness`,
      { method: 'GET' }
    );
