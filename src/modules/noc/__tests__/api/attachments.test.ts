 ...
 * - POST /api/noc/tickets/[id]/attachments (upload)
 * - GET /api/noc/tickets/[id]/attachments (list)
 *
...
describe('POST /api/noc/tickets/[id]/attachments', () => {
  ...
  it('should return 422 for invalid ticket ID format', async () => {
    ...
    const request = new NextRequest('http://localhost/api/noc/tickets/invalid-uuid/attachments', {
      method: 'POST',
      body: formData,
    });
...
describe('GET /api/noc/tickets/[id]/attachments', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('should list all attachments for a ticket', async () => {
    ...
    const { GET } = await import('@/app/api/noc/tickets/[id]/attachments/route');
  ...
  it('should filter attachments by file type', async () => {
    ...
    const request = new NextRequest(
      'http://localhost/api/noc/tickets/' + mockTicketId + '/attachments?file_type=photo',
      { method: 'GET' }
    );
  ...
  it('should filter attachments by evidence flag', async () => {
    ...
    const request = new NextRequest(
      'http://localhost/api/noc/tickets/' + mockTicketId + '/attachments?is_evidence=true',
      { method: 'GET' }
    );
  ...
  it('should filter attachments by verification step', async () => {
    ...
    const request = new NextRequest(
      'http://localhost/api/noc/tickets/' + mockTicketId + '/attachments?verification_step_id=' + stepId,
      { method: 'GET' }
    );
