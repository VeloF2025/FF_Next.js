 ...
 * - GET /api/noc/dr-lookup/[drNumber] - Lookup DR details from SOW module
 *
 * Test Strategy:
...
import { GET } from '@/app/api/noc/dr-lookup/[drNumber]/route';
...
vi.mock('@/modules/noc/services/drLookupService', () => ({
  lookupDR: vi.fn(),
}));
...
describe('DR Lookup API Endpoint', () => {
  ...
  beforeEach(async () => {
    ...
    const { lookupDR } = await import('@/modules/noc/services/drLookupService');
  ...
  describe('GET /api/noc/dr-lookup/[drNumber]', () => {
    it('should return DR details for valid DR number', async () => {
      ...
      const request = new Request('http://localhost:3000/api/noc/dr-lookup/DR12345');
    ...
    it('should return DR details with minimal fields', async () => {
      ...
      const request = new Request('http://localhost:3000/api/noc/dr-lookup/DR99999');
    ...
    it('should return 404 when DR number not found', async () => {
      ...
      const request = new Request('http://localhost:3000/api/noc/dr-lookup/INVALID123');
    ...
    it('should return 422 when DR number is empty', async () => {
      ...
      const request = new Request('http://localhost:3000/api/noc/dr-lookup/   ');
    ...
    it('should return zone and PON information when available', async () => {
      ...
      const request = new Request('http://localhost:3000/api/noc/dr-lookup/DR54321');
    ...
    it('should return location information when available', async () => {
      ...
      const request = new Request('http://localhost:3000/api/noc/dr-lookup/DR11111');
    ...
    it('should return cable information when available', async () => {
      ...
      const request = new Request('http://localhost:3000/api/noc/dr-lookup/DR22222');
