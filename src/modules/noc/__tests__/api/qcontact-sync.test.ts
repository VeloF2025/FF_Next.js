 ...
 * - POST /api/noc/sync/qcontact - Trigger sync
 * - GET /api/noc/sync/qcontact/status - Get sync status
 * - GET /api/noc/sync/qcontact/log - Get sync audit log
 *
 * Test Strategy:
...
describe('QContact Sync API', () => {
  ...
  // ============================================================================
  // POST /api/noc/sync/qcontact
  // ============================================================================

  describe('POST /api/noc/sync/qcontact', () => {
    it('should trigger full bidirectional sync successfully', async () => {
      ...
      const { POST } = await import('@/app/api/noc/sync/qcontact/route');
      const request = new Request('http://localhost/api/noc/sync/qcontact', {
        method: 'POST',
  ...
  // ============================================================================
  // GET /api/noc/sync/qcontact/status
  // ============================================================================

  describe('GET /api/noc/sync/qcontact/status', () => {
    it('should return sync status successfully', async () => {
      ...
      const { GET } = await import('@/app/api/noc/sync/qcontact/status/route');
      const request = new Request(
        'http://localhost/api/noc/sync/qcontact/status',
        {
          method: 'GET',
        }
      );
  ...
  // ============================================================================
  // GET /api/noc/sync/qcontact/log
  // ============================================================================

  describe('GET /api/noc/sync/qcontact/log', () => {
    it('should return sync logs with pagination', async () => {
      ...
      const { GET } = await import('@/app/api/noc/sync/qcontact/log/route');
      const request = new Request(
        'http://localhost/api/noc/sync/qcontact/log',
        {
          method: 'GET',
        }
      );
    ...
    it('should reject invalid sync_direction filter', async () => {
      const { GET } = await import('@/app/api/noc/sync/qcontact/log/route');
      const request = new Request(
        'http://localhost/api/noc/sync/qcontact/log?sync_direction=invalid',
        {
          method: 'GET',
        }
      );
