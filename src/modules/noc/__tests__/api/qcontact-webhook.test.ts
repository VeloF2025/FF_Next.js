 ...
 * - POST /api/noc/webhooks/qcontact - Receive QContact webhooks
 *
 * Test Strategy:
...
describe('QContact Webhook API', () => {
  ...
  // ============================================================================
  // POST /api/noc/webhooks/qcontact - Webhook Receipt
  // ============================================================================

  describe('POST /api/noc/webhooks/qcontact', () => {
    it('should receive and process ticket.created webhook successfully', async () => {
      ...
      const { POST } = await import('@/app/api/noc/webhooks/qcontact/route');
      ...
      const request = new Request('http://localhost/api/noc/webhooks/qcontact', {
        method: 'POST',
        headers: {
