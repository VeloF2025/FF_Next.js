 ...
 * - POST /api/noc/tickets/[id]/risk-acceptance
 * - GET /api/noc/tickets/[id]/risk-acceptances
 * - PUT /api/noc/risk-acceptances/[id]/resolve
 *
 * TDD methodology:
...
describe('POST /api/noc/tickets/[id]/risk-acceptance', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('should create risk acceptance with all fields', async () => {
    ...
    const request = new NextRequest(
      `http://localhost:3000/api/noc/tickets/${mockTicketId}/risk-acceptance`,
      {
        method: 'POST',
  ...
  it('should return 422 for invalid ticket ID format', async () => {
    ...
    const request = new NextRequest(
      'http://localhost:3000/api/noc/tickets/invalid-id/risk-acceptance',
      {
        method: 'POST',
        body: JSON.stringify(requestBody),
      }
...
describe('GET /api/noc/tickets/[id]/risk-acceptances', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('should list all risk acceptances for a ticket', async () => {
    ...
    const request = new NextRequest(
      `http://localhost:3000/api/noc/tickets/${mockTicketId}/risk-acceptances`
    );
  ...
  it('should filter risks by status', async () => {
    ...
    const request = new NextRequest(
      `http://localhost:3000/api/noc/tickets/${mockTicketId}/risk-acceptances?status=resolved`
    );
  ...
  it('should return 422 for invalid ticket ID format', async () => {
    ...
    const request = new NextRequest(
      'http://localhost:3000/api/noc/tickets/invalid-id/risk-acceptances'
    );
...
describe('PUT /api/noc/risk-acceptances/[id]/resolve', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('should resolve a risk acceptance', async () => {
    ...
    const request = new NextRequest(
      `http://localhost:3000/api/noc/risk-acceptances/${mockRiskId}/resolve`,
      {
        method: 'PUT',
        body: JSON.stringify(requestBody),
      }
  ...
  it('should return 422 for invalid risk ID format', async () => {
    ...
    const request = new NextRequest(
      'http://localhost:3000/api/noc/risk-acceptances/invalid-id/resolve',
      {
        method: 'PUT',
        body: JSON.stringify(requestBody),
      }
