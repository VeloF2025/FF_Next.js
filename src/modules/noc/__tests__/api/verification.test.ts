 ...
 * - GET /api/noc/tickets/[id]/verification
 * - PUT /api/noc/tickets/[id]/verification/[step]
 * - POST /api/noc/tickets/[id]/verification/complete
 *
...
describe('GET /api/noc/tickets/[id]/verification', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
...
describe('PUT /api/noc/tickets/[id]/verification/[step]', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('should update step with photo URL', async () => {
    ...
    const request = new NextRequest('http://localhost:3000/api/noc/tickets/123/verification/2', {
      method: 'PUT',
      body: JSON.stringify(requestBody),
    });
...
describe('POST /api/noc/tickets/[id]/verification/complete', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
