 ...
 * - POST /api/noc/tickets/[id]/handover
 * - GET /api/noc/tickets/[id]/handover-history
 *
 * TDD methodology:
...
describe('POST /api/noc/tickets/[id]/handover', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('should create handover snapshot with all required fields', async () => {
    ...
    const request = new NextRequest(
      `http://localhost:3000/api/noc/tickets/${mockTicketId}/handover`,
      {
        method: 'POST',
  ...
  it('should return 422 for invalid ticket ID format', async () => {
    ...
    const request = new NextRequest(
      'http://localhost:3000/api/noc/tickets/invalid-id/handover',
      {
        method: 'POST',
        body: JSON.stringify(requestBody),
      }
...
describe('GET /api/noc/tickets/[id]/handover-history', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('should get handover history for a ticket', async () => {
    ...
    const request = new NextRequest(
      `http://localhost:3000/api/noc/tickets/${mockTicketId}/handover-history`
    );
  ...
  it('should return 422 for invalid ticket ID format', async () => {
    ...
    const request = new NextRequest(
      'http://localhost:3000/api/noc/tickets/invalid-id/handover-history'
    );
