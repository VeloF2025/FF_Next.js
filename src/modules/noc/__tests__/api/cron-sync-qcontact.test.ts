 ...
 * - POST /api/noc/cron/sync-qcontact
...
import { POST, GET } from '@/app/api/noc/cron/sync-qcontact/route';
import { NextRequest } from 'next/server';

// Mock dependencies
vi.mock('@/modules/noc/jobs/qcontactSync', () => ({
  runSyncJob: vi.fn(),
}));
...
describe('POST /api/noc/cron/sync-qcontact', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('should execute sync job successfully', async () => {
    ...
    const request = new NextRequest('http://localhost:3000/api/noc/cron/sync-qcontact', {
      method: 'POST',
    });
...
describe('GET /api/noc/cron/sync-qcontact', () => {
