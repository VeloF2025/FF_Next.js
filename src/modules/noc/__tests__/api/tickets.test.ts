 ...
 * - GET /api/noc/tickets - List tickets with filters
 * - POST /api/noc/tickets - Create ticket
...
describe('Ticket CRUD API Endpoints', () => {
  ...
  describe('GET /api/noc/tickets - List tickets', () => {
  ...
  describe('POST /api/noc/tickets - Create ticket', () => {
  ...
  describe('GET /api/noc/tickets/[id] - Get ticket detail', () => {
  ...
  describe('PUT /api/noc/tickets/[id] - Update ticket', () => {
  ...
  describe('DELETE /api/noc/tickets/[id] - Soft delete ticket', () => {
