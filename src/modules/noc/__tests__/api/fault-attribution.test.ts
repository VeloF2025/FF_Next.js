 ...
 * - PUT /api/noc/tickets/[id]/fault-cause - Set fault cause for ticket
 * - GET /api/noc/analytics/fault-trends - Get fault trends by cause/location
 *
 * Test Strategy:
...
describe('Fault Attribution API Endpoints', () => {
  ...
  // ==================== PUT /api/noc/tickets/[id]/fault-cause ====================

  describe('PUT /api/noc/tickets/[id]/fault-cause - Set fault cause', () => {
