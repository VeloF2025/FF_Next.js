...
export function validateQAReadiness(
  ...
  if (!drPopulated) {
    failedChecks.push({
      ...
      actual: input.dr_number ?? undefined,
    });
  }
  ...
  if (!polePopulated) {
    failedChecks.push({
      ...
      expected: 'Non-empty string',
      actual: input.pole_number ?? undefined,
    });
  }
  ...
  if (!ponPopulated) {
    failedChecks.push({
      ...
      expected: 'Non-empty string',
      actual: input.pon_number ?? undefined,
    });
  }
  ...
  if (!zonePopulated) {
    failedChecks.push({
      ...
      expected: 'Non-empty string',
      actual: input.zone_id ?? undefined,
    });
  }
  ...
  if (!ontSerialRecorded) {
    failedChecks.push({
      ...
      expected: 'Non-empty string',
      actual: input.ont_serial ?? undefined,
    });
  }
  ...
  if (!ontRxRecorded) {
    failedChecks.push({
      ...
      actual: input.ont_rx_level ?? undefined,
    });
  }
