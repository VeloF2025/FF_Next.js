...
// Maps each Offline ONT site (SharePoint folder name) to its NOC maintenance
// team UUID. Etwatwa POP folders (ETW-1, ETW-2) route to the single
// "Etwatwa Maintenance" team.
export const SITE_MAINTENANCE_TEAMS = {
  ...
  'ETW-1': '3012ec9e-8b00-44cb-97c8-0f5b9270c502',
  'ETW-2': '3012ec9e-8b00-44cb-97c8-0f5b9270c502',
} as const;
