...
export function StaffDetail() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'inactive': return 'bg-secondary text-foreground';
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-card rounded-lg shadow-sm border border-border">
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Project Information */}
          <div>
            <h2 className="text-lg font-medium text-foreground mb-4">Project Information</h2>
          ...
          {(staff.emergencyContactName || staff.emergencyContactPhone) && (
            <div>
              <h2 className="text-lg font-medium text-foreground mb-4">Emergency Contact</h2>
              <div className="bg-red-50 rounded-lg p-4">
                {staff.emergencyContactName && (
                  <p className="font-medium text-foreground">{staff.emergencyContactName}</p>
                )}
