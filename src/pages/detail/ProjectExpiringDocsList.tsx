...
import { AlertTriangle, Clock, ExternalLink, FileText, ChevronRight, Loader2 } from 'lucide-react';
...
export function ProjectExpiringDocsList({
  projectId,
  onNavigateToDocuments,
  maxItems = 5,
}: ProjectExpiringDocsListProps) {
  ...
  // Filter to show most urgent documents
  const urgentDocs = [
  ...
  // If no expiring docs, show positive message
  ...
  const displayDocs = urgentDocs.slice(0, maxItems);
  ...
  return (
    <div className="bg-[var(--ff-bg-secondary)] rounded-lg border border-[var(--ff-border-light)] overflow-hidden">
      ...
      {/* Show more */}
      {remaining > 0 && onNavigateToDocuments && (
        <button
          onClick={onNavigateToDocuments}
