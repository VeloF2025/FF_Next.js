  ...
  return (
    <div className={`rounded-lg border ${config.borderColor} ${config.bgColor} p-4`}>
      ...
      {showNotes ? (
        <div className="mb-3">
          ...
          <div className="flex gap-2 mt-2">
            ...
            <button
              ...
              className="px-3 py-1 bg-secondary text-muted-foreground text-sm rounded hover:bg-gray-300"
            >
              Cancel
            </button>
          </div>
        ...
        stage.notes && (
          <div className="mb-3 p-2 bg-card rounded text-sm text-muted-foreground">
            {stage.notes}
          </div>
        )
      )}
      ...
      <div className="flex flex-wrap gap-2">
        ...
        {!showNotes && (
          <button
            ...
            className="px-3 py-1.5 bg-secondary text-muted-foreground text-sm rounded hover:bg-gray-300"
          >
