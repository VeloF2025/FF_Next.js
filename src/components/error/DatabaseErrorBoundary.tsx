              ...
              <div className="bg-card rounded-lg shadow-lg p-8 text-center">
                ...
                <div className="space-y-3">
                  ...
                  <button 
                    ...
                    className="w-full bg-secondary hover:bg-secondary text-muted-foreground font-medium py-3 px-4 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
                  >
                    Reload Application
                  </button>
                </div>
                ...
                <details className="mt-6 text-left">
                  <summary className="text-sm text-muted-foreground cursor-pointer hover:text-muted-foreground focus:outline-none">
                    Technical Details
                  </summary>
          ...
          <div className="max-w-md w-full">
            <div className="bg-card rounded-lg shadow-lg p-6 text-center">
              ...
              <div className="space-y-2">
                ...
                <button 
                  onClick={this.handleReload}
                  className="w-full bg-secondary hover:bg-secondary text-muted-foreground font-medium py-2 px-4 rounded-lg transition-colors"
                >
                  Reload Page
                </button>
              </div>
              ...
              <details className="mt-4 text-left">
                ...
                <div className="mt-2 p-2 bg-secondary rounded text-xs font-mono text-muted-foreground break-all">
