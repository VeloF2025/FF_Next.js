  ...
  if (isLoading) {
    return (
      <div className={`flex items-center justify-center h-64 ${className}`}>
        ...
        <span className="ml-2 text-muted-foreground">Loading mapping review...</span>
      </div>
    );
  }
  ...
  if (!boq) {
    return (
      <div className={`flex items-center justify-center h-64 ${className}`}>
        ...
        <span className="ml-2 text-muted-foreground">BOQ not found</span>
      </div>
    );
  }
    ...
    <div className={`space-y-4 ${className}`}>
      ...
      <div className="bg-card rounded-lg border p-4">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-lg font-medium text-foreground">Mapping Review</h2>
        ...
        <div className="bg-card rounded-lg border p-4">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-2xl font-bold text-foreground">{totalExceptions}</p>
            </div>
          </div>
        </div>
        <div className="bg-card rounded-lg border p-4">
