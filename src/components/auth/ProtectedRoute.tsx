      ...
      <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 text-center">
        ...
        {currentUser && (
          <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 mb-6 text-left">
            <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-2">Your Current Access:</h3>
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 py-2 px-4 rounded-lg hover:bg-gray-300 transition-colors"
          >
            Sign Out
          </button>
        </div>
