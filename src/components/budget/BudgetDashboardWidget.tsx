  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 mt-4 pt-4 border-t border-gray-100">
          ...
          <div className="text-center">
            ...
            <p className="text-sm font-semibold text-gray-900">{formatCompact(actualAmount, currency)}</p>
          </div>
          <div className="text-center">
      ...
      <Link
        ...
        className="flex items-center justify-between p-3 bg-gray-50 border-t border-gray-100 hover:bg-gray-100 transition-colors"
      >
        <span className="text-sm font-medium text-gray-600">View Budget Details</span>
  ...
  return (
    ...
    >
      <div className="text-center py-4">
        ...
        <h3 className="text-sm font-semibold text-gray-700 mb-1">No Budget Set</h3>
