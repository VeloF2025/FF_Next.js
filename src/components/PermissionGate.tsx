...
export function PermissionGate({
  ...
  if (isLoading && showLoading) {
    return (loadingComponent as React.ReactElement) || (
      <div className="animate-pulse h-4 w-24 bg-secondary rounded" />
    );
  }
    ...
    <div className="flex flex-col items-center justify-center min-h-[200px] p-8 text-center">
      ...
      {showBackButton && (
        <button
          ...
          className="px-4 py-2 bg-secondary hover:bg-secondary text-muted-foreground rounded-lg transition-colors"
        >
          Go Back
        </button>
      )}
