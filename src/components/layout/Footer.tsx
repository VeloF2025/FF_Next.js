...
export function Footer(): JSX.Element {
  ...
  return (
    <footer className="bg-[var(--ff-surface-primary)] border-t border-[var(--ff-border-primary)] py-2 px-4 lg:px-6">
      <div className="flex items-center justify-center gap-3 text-xs text-[var(--ff-text-tertiary)]">
