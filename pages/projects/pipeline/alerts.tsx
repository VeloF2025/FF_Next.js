 ...
 * /projects/pipeline/alerts - Shows expiring approvals and due follow-ups
 */
  ...
  return (
    <div className="p-6 space-y-6 animate-pulse">
      ...
      <div className="grid grid-cols-4 gap-4">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="h-24 bg-[var(--ff-bg-tertiary)] rounded-lg" />
        ))}
      </div>
      <div className="h-64 bg-[var(--ff-bg-tertiary)] rounded-lg" />
      <div className="h-64 bg-[var(--ff-bg-tertiary)] rounded-lg" />
    </div>
  );
}
